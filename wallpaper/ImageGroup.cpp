...
ImageGroup::ImageGroup(const QString& path, const QStringList& img_paths, QObject* parent)
    : QObject(parent)
    , all_images_(img_paths.begin(), img_paths.end())
    , path_(path)
{
...
//向图片数组中添加图片
bool ImageGroup::addImage(const QVector<QString>& img_paths)
{
